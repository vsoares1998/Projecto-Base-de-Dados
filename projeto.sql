...
BEGIN
	...
	IF End_Date IS NOT NULL THEN
		 -- SET End_Date = CURDATE();
		 SELECT DATEDIFF(End_Date,Start_Date) INTO DIASDECORRIDOS; -- FUNÇAO
		 -- DATE A DAR VALOR 500 OU SEJA VALOR ERRADO
		 IF DIASDECORRIDOS >= 15 THEN
			 SET Fine = 1.0 + 0.15 * DIASDECORRIDOS;
			 IF DIASDECORRIDOS >= 30 THEN
...
CALL InsertRent('2020-05-06',NULL,1,1,3,124578924,@Fine);
CALL InsertRent('2020-10-11','2020-10-16',1,2,3,124578924,@Fine);
